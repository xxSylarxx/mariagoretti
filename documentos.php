...
<body>
    ...
    <section class="container-fluid px-0" id="portada">
        <div class="container px-3">
            ...
            <h1 style="color:var(--color8);font-weight:bold;">Comunicados</h1>
        </div>
    </section>
    ...
    <section class="container">
        <h2 style="color:var(--color1);font-weight:bold;text-align:center;">Comunicados</h2>
        <br><br>
            ...
            <div class="row justify-content-between">
                            ...
                            <a href="view.php?id=1">
                                <div class="card shadow-sm " style="background: rgb(248, 248, 248);">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="fw-bold text-uppercase" style="font-size: 18px;color:var(--color11);">Bienvenidos al IV Bimestre</h5>
                ...
                <div class="col-lg-3 pt-4">
                    <div class="list-group">
                        ...
                        <a href="./documentos.php" class="list-group-item active ">Documentos</a>
