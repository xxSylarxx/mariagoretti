...
<head>
    ...
    <title>ARCHIVOS - <?php echo EMPRESA ?></title>
    ...
    <script>
        new Vue({
            ...
            methods: {
                ...
                cargarArchivo() {
                    let vue = this;
                    let uri = "/admin/archivos/guardar";
                    let fileup = document.getElementById("fileupload").files[0];
                    let sizekb = parseInt(fileup.size / 1024);
                    if (sizekb > 40120) {
                        ...
                        dir["3"] = "/video/";
                        dir["4"] = "/files/";
                        data.append("path", dir[vue.tabactive] + vue.clean_name_file(fileup.name));
                ...
                copiarEnlace(path) {
                    ...
                    aux.remove();
                    this.mostrarMessage("Enlace copiado al portapapeles", "success");
                },
                eliminarArchivo(path) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            if (resp.trim() == "OK") {
                                vue.listarArchivos(vue.tabactive);
                                this.mostrarMessage("Archivo eliminado", "success");
                            } else {
                                this.mostrarMessage(resp, "error");
                            }
                        }
                    });
                },
                ...
                clean_name_file(cadena) {
                    let str = cadena;
                    str = str.replace(/\s+/g, '-'); // remplaza espacios por '-'
                    str = str.normalize("NFD").replace(/[\u0300-\u036f]/g, ""); // quita y remplaza las tíldes
                    return str;
                },
